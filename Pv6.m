...
% Part 2-2a)  Forward Subset Selection - Obtaining features for corresponding min MCE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('Number of Features');
ylabel('CV MCE');
title('Forward Sequential Feature Selection with cross-validation - QDA');
...
fun_svm = @(XT,yT,Xt,yt)loss(fitcsvm(XT,yT,'KernelFunction','linear'),Xt,yt)
...
xlabel('Number of Features');
ylabel('CV MCE');
title('Forward Sequential Feature Selection with cross-validation - Linear SVM');
...
xlabel('Number of Features');
ylabel('CV MCE');
title('Forward Sequential Feature Selection with cross-validation - Gaussian SVM');
...
% Calculating the Testing error using the model
Mdl_FS_svm_gaussian = fitcsvm(X_train_norm(:,fsLocal_svm_Gaussian), Y_train,'KernelFunction','linear');
